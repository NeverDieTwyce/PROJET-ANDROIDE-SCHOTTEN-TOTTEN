...
# Renvoie le nombre de victoire de la strat_k avec k = k1 contre k=k2
...
for k1 in range(1,6):
    ...
    for k2 in range(k1,6):
        ...
        print(k1, " contre ", k2, " , nombre de victoire sur 1000 parties = ", nb_victory)
        # Renvoie le nombre de victoire pour k1