...
def worker(args):
    game_copy, coup, nb_simul, depth = args
    return game_copy.simulation(coup, nb_simul, depth)
...
def one_game_ia_first(nb_simul1, nb_simul2):
    ...
    with multiprocessing.Pool(num_cores) as pool:
        while not game.game_over():
            ...
            if coup_rais:
                args_list = [(game, coup, nb_simul1, 3) for coup in coup_rais]
            ...
            if coup_rais2:
                args_list = [(game, coup, nb_simul2, 3) for coup in coup_rais2]
...
if __name__ == '__main__':
    print("100 vs 0")
    #victoires = stat_game_(50, 100, 1000)
    victoires = stat_game_2(100, 1000)
